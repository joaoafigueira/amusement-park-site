...
<link rel="stylesheet" href="../CSS/style-admin-logado.css">

<!-- FRAMEWORK BOOSTRAP -->
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css">

<!-- ICONE DA PÁGINA-->
<link rel="shortcut icon" href="../IMG/admin.png" type="imagem/png">
			...
			<div class="row">
				<div class="col-md-4 mt-1">
					<div class="card text-center sidebar">
						<div class="card-body">
							<img src="../IMG/amin.png" class="rounded-circle" width="150">
							<div class="mt-3">
								<h3>Nome de usuário: 
								<%=admin.getAdminUser() %>
								</h3>
